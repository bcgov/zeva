    ...
    <div id="actions" className="dashboard-card">
      <div className="content">
        ...
        <ActivityBanner
          ...
          linkTo={`${ROUTES_CREDITS.LIST}?status=Submitted`}
        />
        )}
        ...
        <ActivityBanner
          ...
          linkTo={`${ROUTES_CREDITS.LIST}?status=Recommend%20Approval`}
        />
        )}
        ...
        <ActivityBanner
          ...
          linkTo={`${ROUTES_CREDITS.LIST}?status=Recommend%20Rejection`}
        />
        )}
