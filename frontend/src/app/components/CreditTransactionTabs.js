  ...
  return (
    <ul className="nav nav-tabs" key="tabs" role="tablist">
      {!user.isGovernment && (
        <li
          className={`nav-item ${
            active === 'credit-transactions' ? 'active' : ''
          }`}
          role="presentation"
        >
      ...
      {CONFIG.FEATURES.CREDIT_TRANSFERS.ENABLED && (
        <li
          className={`nav-item ${
            active === 'credit-transfers' ? 'active' : ''
          }`}
          role="presentation"
        >
      ...
      {typeof user.hasPermission === 'function' &&
        ...
        user.isGovernment && (
          <li
            ...
            role="presentation"
          >
            <Link to={ROUTES_CREDITS.UPLOAD_VERIFICATION}>
              Update ICBC Data
            </Link>
          </li>
        )}
      {CONFIG.FEATURES.INITIATIVE_AGREEMENTS.ENABLED && (
        <li
          className={`nav-item ${
            active === 'initiative-agreements' ? 'active' : ''
          }`}
          role="presentation"
        >
      ...
      {CONFIG.FEATURES.PURCHASE_REQUESTS.ENABLED && (
        <li
          className={`nav-item ${
            active === 'purchase-requests' ? 'active' : ''
          }`}
          role="presentation"
        >
