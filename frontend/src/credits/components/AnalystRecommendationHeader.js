...
const AnalystRecommendationHeader = (props) => {
  ...
  return (
    <div className="p-2">
      {['RECOMMEND_APPROVAL', 'RECOMMEND_REJECTION','CHECKED','REJECTED', 'VALIDATED'].indexOf(validationStatus) >= 0
          ...
          <div className="row mt-2"> 
            <div className="col-1">
              <input
                ...
                disabled={user.hasPermission('SIGN_SALES') && ['RECOMMEND_APPROVAL', 'RECOMMEND_REJECTION','REJECTED', 'VALIDATED'].indexOf(validationStatus) >= 0 ? true : false}
              />
            </div>
            <div className="col-9">
              <ul className="pl-0" style={{"list-style": "none"}}>
                    <li className="font-italic text-blue">
                      <label className="pl-0 text-blue">Issue as Sept 30 as part of a Model Year Report </label>
                    </li>
              </ul>
           </div>
         </div>
