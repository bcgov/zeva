    ...
    <>
        ...
        <>
          <div className="form-group row mb-0">
            <div className="col-12">
              ...
              <span className="text-blue d-md-block d-lg-inline">
                (must be a B.C. address)
              </span>
            </div>
          </div>
          <TextInput
            ...
            labelSize={`col-lg-12 col-xl-5 col-form-label ${
              type === 'Service' ? '' : 'd-xl-none'
            }`}
      ...
      {type === 'Records' && (
        <div className="form-group row records-address">
          <div className="col-12">
            <h3 className="d-lg-block d-xl-inline d-md-block mr-3 d-sm-block">
              {title}
            </h3>
      ...
      <TextInput
        addressType={type}
        defaultValue={
          type === 'Service' ? 'BC' : addressDetails[`${type}_state`]
        }
        disabled={serviceSame}
      ...
      <TextInput
        addressType={type}
        defaultValue={
          type === 'Service' ? 'Canada' : addressDetails[`${type}_country`]
        }
        disabled={serviceSame}
