      ...
      <div className="form-group row p-3">
        <table className="m-auto">
          ...
          <>
            ...
            <tr>
              <td className="text-blue">
                Estimated Class A Credit Total:
              </td>
              <td className="pl-3 text-right">
                {estimatedModelSales && formatNumeric(estimatedModelSales.filter((each) => each.creditClass === 'A').reduce((a, v) => a + v.value, 0))}

              </td>
            </tr>
            <tr>
              <td className="text-blue">
                Estimated Class B Credit Total:
              </td>
              <td className="pl-3 text-right">
                {estimatedModelSales && formatNumeric(estimatedModelSales.filter((each) => each.creditClass === 'B').reduce((a, v) => a + v.value, 0))}
