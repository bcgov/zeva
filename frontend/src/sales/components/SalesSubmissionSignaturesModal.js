  ...
  return (
    ...
    >
      ...
      <div>
        ...
        <label className="d-inline" htmlFor="sd-1"> confirm that records
      ...
      <div>
        ...
        <label className="d-inline" htmlFor="sd-2"> confirm that I am an
      ...
      <div>
        ...
        <label className="d-inline" htmlFor="sd-3"> certify that the
