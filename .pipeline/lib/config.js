...
const phases = {
  ...
  test: {namespace:'tbiwaq-test', name: `${name}`, ssoSuffix:'-test', 
        ...
        backendCpuRequest: '100m', backendCpuLimit: '400m', backendMemoryRequest: '500M', backendMemoryLimit: '700M', backendHealthCheckDelay: 10, backendMinReplicas: 2, backendMaxReplicas: 5,
        minioCpuRequest: '50m', minioCpuLimit: '200m', minioMemoryRequest: '500M', minioMemoryLimit: '700M',
  ...
  prod: {namespace:'tbiwaq-prod', name: `${name}`, ssoSuffix:'', 
        ...
        backendCpuRequest: '200m', backendCpuLimit: '500m', backendMemoryRequest: '1G', backendMemoryLimit: '2G', backendHealthCheckDelay: 10, backendMinReplicas: 2, backendMaxReplicas: 5,
