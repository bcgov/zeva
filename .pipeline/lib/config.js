...
const phases = {
  ...
  test: {namespace:'tbiwaq-test', name: `${name}`, ssoSuffix:'-test', 
        ...
        frontendCpuRequest: '300m', frontendCpuLimit: '600m', frontendMemoryRequest: '500M', frontendMemoryLimit: '1G', frontendMinReplicas: 2, frontendMaxReplicas: 5,
  ...
  prod: {namespace:'tbiwaq-prod', name: `${name}`, ssoSuffix:'', 
        ...
        frontendCpuRequest: '300m', frontendCpuLimit: '600m', frontendMemoryRequest: '1G', frontendMemoryLimit: '2G', frontendMinReplicas: 2, frontendMaxReplicas: 5,
