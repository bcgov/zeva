...
const phases = {
  ...
  dev: {namespace:'tbiwaq-dev', transient:true, name: `${name}`, ssoSuffix:'-dev', 
        ...
        frontendCpuRequest: '100m', frontendCpuLimit: '300m', frontendMemoryRequest: '300M', frontendMemoryLimit: '500M',
  ...
  test: {namespace:'tbiwaq-test', name: `${name}`, ssoSuffix:'-test', 
        ...
        frontendCpuRequest: '100m', frontendCpuLimit: '500m', frontendMemoryRequest: '300M', frontendMemoryLimit: '500M', frontendMinReplicas: 2, frontendMaxReplicas: 5,
        backendCpuRequest: '100m', backendCpuLimit: '500m', backendMemoryRequest: '500M', backendMemoryLimit: '700M', backendHealthCheckDelay: 140, backendMinReplicas: 2, backendMaxReplicas: 5, backendHost: `zeva-backend-test.pathfinder.gov.bc.ca`,
  ...
  prod: {namespace:'tbiwaq-prod', name: `${name}`, ssoSuffix:'', 
        ...
        frontendCpuRequest: '200m', frontendCpuLimit: '500m', frontendMemoryRequest: '1G', frontendMemoryLimit: '2G', frontendMinReplicas: 2, frontendMaxReplicas: 5,
        backendCpuRequest: '200m', backendCpuLimit: '700m', backendMemoryRequest: '1G', backendMemoryLimit: '2G', backendHealthCheckDelay: 140, backendMinReplicas: 2, backendMaxReplicas: 5, backendHost: `zeva-backend-prod.pathfinder.gov.bc.ca`,
