...
const phases = {
  ...
  dev: {namespace:'tbiwaq-dev'       , transient:true, name: `${name}`, ssoSuffix:'-dev', 
        ...
        backendCpuRequest: '100m', backendCpuLimit: '400m', backendMemoryRequest: '500M', backendMemoryLimit: '700M', backendHealthCheckDelay: 30,
  ...
  test: {namespace:'tbiwaq-test'     , name: `${name}`, ssoSuffix:'-test', 
        ...
        rabbitmqCpuRequest: '250m', rabbitmqCpuLimit: '300m', rabbitmqMemoryRequest: '512M', rabbitmqMemoryLimit: '1G', rabbitmqPvcSize: '1G', rabbitmqPodManagementPolicy: 'OrderedReady', rabbitmqReplica: 3, rabbitmqPostStartSleep: 120,
        patroniCpuRequest: '250m', patroniCpuLimit: '500m', patroniMemoryRequest: '1G', patroniMemoryLimit: '2G', patroniPvcSize: '1G', patroniPodManagementPolicy: 'OrderedReady', patroniReplica: 3},
