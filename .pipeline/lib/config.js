...
const phases = {
  ...
  dev: {namespace:'tbiwaq-dev'       , transient:true, name: `${name}`, ssoSuffix:'-dev', 
        ...
        backendCpuRequest: '20m', backendCpuLimit: '50m', backendMemoryRequest: '500M', backendMemoryLimit: '700M', backendHealthCheckDelay: 90,
        minioCpuRequest: '20m', minioCpuLimit: '50m', minioMemoryRequest: '500M', minioMemoryLimit: '700M',
        schemaspyCpuRequest: '20m', schemaspyCpuLimit: '300m', schemaspyMemoryRequest: '250M', schemaspyMemoryLimit: '1500M', schemaspyHealthCheckDelay: 90,
