    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('previous_state', enumfields.fields.EnumField(default='NEW', enum=api.models.vehicle.VehicleDefinitionStates, max_length=20)),
                ('current_state', enumfields.fields.EnumField(default='NEW', enum=api.models.vehicle.VehicleDefinitionStates, max_length=20)),
